package com.xiaozhameng.plugin;
...
/**
 * @项目名称：xiaozhameng-MybatisGenerator-demo
 * @类名称：XiaoZhaMengPlugin
 * @类描述：自定义代码生成器
 * @创建人：Maimangxiaozhameng
 */
public class XiaoZhaMengPlugin extends PluginAdapter {
    /**
     * 生成dao
     */
    @Override
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        FullyQualifiedJavaType imp = new FullyQualifiedJavaType("com.xiaozhameng.base.BaseDao");
    ...
    public static void generate() {
        String config = XiaoZhaMengPlugin.class.getClassLoader().getResource("mybatisConfig.xml").getFile();
